  ...
  return (
    <div className="min-h-screen bg-primary-900 flex items-center justify-center px-6 relative">
      ...
      <motion.div className="text-center z-10" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
        <motion.div
          className="w-24 h-24 rounded-3xl bg-neon-purple/10 border border-neon-purple/20 flex items-center justify-center mx-auto mb-8"
          animate={{ scale: [1, 1.05, 1] }}
          transition={{ duration: 2, repeat: Infinity }}
        >
          <Server className="w-12 h-12 text-neon-purple" />
        </motion.div>
        <h1 className="text-8xl font-black gradient-text mb-4">500</h1>
